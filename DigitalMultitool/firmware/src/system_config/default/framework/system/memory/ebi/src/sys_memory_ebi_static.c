...
void SYS_MEMORY_EBI_Initialize(void)
{
    ...
    /* Setup EBIMSK0 */
    PLIB_EBI_MemoryCharacteristicsSet(EBI_ID_0, 0, SRAM, MEMORY_SIZE_1MB, CS_TIMING_0);
    /* Setup EBISMT0 */
    ...
    PLIB_EBI_MemoryTimingConfigSet(EBI_ID_0, 0, 0, 0, 7, 0, 0, 9);
    /* Setup EBISMCON->SMWIDTH0 */
    PLIB_EBI_StaticMemoryWidthRegisterSet(EBI_ID_0, 0, MEMORY_WIDTH_8BIT);
}
