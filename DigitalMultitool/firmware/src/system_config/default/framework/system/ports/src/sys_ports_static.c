...
void SYS_PORTS_Initialize(void)
{
    ...
    /* PPS Input Remapping */
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_INT2, INPUT_PIN_RPF8 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_SDI3, INPUT_PIN_RPD14 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_SDI4, INPUT_PIN_RPD11 );

    /* PPS Output Remapping */
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO3, OUTPUT_PIN_RPD15 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO4, OUTPUT_PIN_RPD0 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SS1, OUTPUT_PIN_RPG6 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO1, OUTPUT_PIN_RPG7 );
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SS4, OUTPUT_PIN_RPD4 );
