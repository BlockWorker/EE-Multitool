...
const DRV_SDCARD_INIT drvSDCardInit =
{
    ...
    .chipSelectBitPosition = PORTS_BIT_POS_6,
};
// </editor-fold>
...
void SYS_Initialize ( void* data )
{
    ...
    SYS_INT_VectorPrioritySet(INT_VECTOR_SPI4_TX, INT_PRIORITY_LEVEL1);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_SPI4_TX, INT_SUBPRIORITY_LEVEL0);
    SYS_INT_VectorPrioritySet(INT_VECTOR_SPI4_RX, INT_PRIORITY_LEVEL1);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_SPI4_RX, INT_SUBPRIORITY_LEVEL0);
    SYS_INT_VectorPrioritySet(INT_VECTOR_SPI4_FAULT, INT_PRIORITY_LEVEL1);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_SPI4_FAULT, INT_SUBPRIORITY_LEVEL0);
